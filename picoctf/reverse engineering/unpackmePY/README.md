### [play the CTF here](https://play.picoctf.org/practice/challenge/314?category=3&page=1&search=.py)
```python
import base64
...
# ------------ Code I put vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
print("-------------------- Just copy the picoCTF{xxxx} part, Its your flag!! -----------------------\n\n")
print(plain.decode())
print("\n\n----------------------------------------------------------------------")
# ------------- Code I put ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
